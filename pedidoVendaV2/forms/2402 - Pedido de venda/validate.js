...
var beforeSendValidate = function(numState) {
  ...
  $('#pv_total_original').val($('#pv_total').val());
    validaHeader();
    var camposProduto = new Array('pv_produto_cod', 'pv_produto_desc', 
                                  'pv_pro_modelo','pv_pro_qyt', 'pv_pro_qty', 'pv_pro_custo',
                                  'pv_pro_total','pv_pro_pri','pv_crdd');
