...
function createDataset(fields, constraints, sortFields) {
	...
	dataset.addColumn("parentDocumentId");
    ...
    var parentId = getPametro(constraints,'parentDocumentId');
    ...
    if(parentId != ''){
	    try {
	        ...
	        var CardDto = servico.instantiate("com.totvs.technology.ecm.dm.ws.CardDto");
	        log.info('%%%%%% CardDto: ' + CardDto);
	       
	        
	//        var CardFieldDtoArray = servico.instantiate("com.totvs.technology.ecm.dm.ws.CardFieldDtoArray");
	//        log.info('%%%%%% CardFieldDtoArray: ' + CardFieldDtoArray);
	        
	        var cardDtoArray = servico.instantiate("com.totvs.technology.ecm.dm.ws.CardDtoArray");
	...
	//            CardFieldDtoArray.getItem().add(cardfield);
	            CardDto.getCardData().add(cardfield)
	        }
	        cardDtoArray.getItem().add(CardDto);
	        var WSretorno = portServico.create(empresa, user, password, cardDtoArray);
