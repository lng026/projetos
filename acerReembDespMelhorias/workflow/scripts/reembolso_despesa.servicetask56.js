   ...
   var caminho = pre + '.WSFLUIG';
     ...
     */
     ...
     if(result.getCERRO() == "S"){
    	 ...
    	 var msgRet = result.getCMSG();
    	 if( msgRet.indexOf('ID JA CADASTRADO')>=0){
    		 hAPI.setCardValue('cchave', CID);
    	 }
    	 hAPI.setTaskComments(usuario, CID, 0,'msgRetorno Erro:' + result.getCMSG() +  result.getCCHAVE());
