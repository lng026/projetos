...
var beforeSendValidate = function(numState, nextState) {
    ...
    var cValidade = customValidadeBefore(numState, nextState);
    if(cValidade != true){
       throw cValidade;
    }
            ...
            case "INPUT":
                ...
                if (tipo == "radio") {
                    ...
                    if ($(this).checked == false) {
                        ...
                        $(this).closest(".col").addClass("has-error");
                    }
                }else{
    ...
    if (aLbl.length > 0) {
        ...
        var cValAfter = customValidadeAfter(numState, nextState);
    }
}
...
function camposObrigatorios() {
    $("input:required, select:required, textarea:required").each(function(index, value){
      ...
      if($(this)[0].type == "radio"){
			...
			$(this).parent().find("label:first").append("<span class='obg'> *</span>");
      }
    });
}
