...
var buscaAdiantamentos = function (cpf){
	var constraintDsAdiantamentos1 = DatasetFactory.createConstraint('cgc', '14856969846', '14856969846', ConstraintType.MUST);
	var dsAdiantamentos = DatasetFactory.getDataset('dsAdiantamentos', null, new Array(constraintDsAdiantamentos1), null);
	return dsAdiantamentos.values;
}
