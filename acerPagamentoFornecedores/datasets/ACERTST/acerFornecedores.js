...
function createDataset(fields, constraints, sortFields) {
	...
	if((param != '' && param.length() > 2) ||(param2 != '' &&  param2.length() > 2 )){
		try {
		    ...
		    var cliResponse = service.getfornecedores(param.toUpperCase(),param2.trim(), "");
		    var cli = cliResponse.getFORNECEDOR();
		...
		dataset.addRow(new Array('Erro', "Informe o nome do fornecedor"));
	}
	return dataset;
