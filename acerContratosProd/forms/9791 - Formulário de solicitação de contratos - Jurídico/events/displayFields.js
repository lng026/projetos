...
//	customHTML.append("selectTipoDoc();");
	...
	var coletaAssina = (atv == 34|| atv ==221) ? ".show();" : ".hide();"; 
	...
	var comentview = (atv == 5 || atv == 44 || atv == 48 || atv == 51 || atv == 56 || atv == 30 || atv == 32 || atv == 34 || atv == 38 || atv == 106 || atv == 146 || atv == 149 || atv == 150 || atv == 160 || atv == 204 || atv==221) ? ".show();" : ".hide();";
...
//	}
	...
	if (atv == 204) {
		form.setVisibleById("divAprovPresid", true);
				
		customHTML.append("\n$(\"#divAnaliseFin\").show();\n");
		customHTML.append("\n$(\"#divAnaliseFin legend\").html(\"Histórico de Mensagens\");\n");
	}else if (atv == 96){
		var verificarValor = form.getValue("AprovPresid")
		if(verificarValor == "nao"){
			form.setVisibleById("divAprovPresid", true);
			form.setEnabled("AprovPresid", false);
			form.setEnabled("AprovPresidObs", false);
		}else{
			form.setVisibleById("divAprovPresid", false);
		}
	}else{
		form.setVisibleById("divAprovPresid", false);
	}
	...
	if (atv != 61 || atv != 204 || atv != 34 || atv!=221) {
		customHTML.append("\n$(\"#aprovSuperior\").val(\"\");\n");
	}
