function createDataset(fields, constraints, sortFields) {
	...
	try{
		...
		dsConsultivoSIGAJURI.addRow(new Array(retorno.getNUMEROCONSULTA(), retorno.getCODIGOJURIDICO(), retorno.getFLUXOAPROVACAO(), retorno.getCODIGOFOLLOWUP()));
	}
	catch(e){
		...
		log.info("** dsConsultivoSIGAJURI CONSTRAINS: ");
		for (var i = 0; i < constraints.length; i++){
